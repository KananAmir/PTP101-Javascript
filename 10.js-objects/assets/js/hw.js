...
console.log(numbers.reduce((result, item) => result * item));
...
const totalMoney = products.reduce((total, item) => {
...
console.log([[[1, 2, 3], [1, 2], [[1, 2]]]].flat(1)); // [[1,2,3], [1,2], [[1,2]]
console.log([[[1, 2, 3], [1, 2], [[1, 2]]]].flat(2)); // [1,2,3], [1,2], [1,2]
console.log([[[1, 2, 3], [1, 2], [[1, 2]]]].flat(3)); // [1,2,3, 1,2, 1,2]
...
// arr.forEach((item)=>{
//     if(item.name.length > maxLengthName.name.length){
//         maxLengthName = item
//     }
// })
...
// const maxLengthNameElement = arr.reduce((acc, curr) => {
...
console.log(maxLengthNameElement.key);
...
arr.forEach((item, index, arr)=>{
    if(item.name.toLowerCase().indexOf('l') !== item.name.toLowerCase().lastIndexOf('l')){
        console.log(index);
...
console.log(arr.filter((item)=> item.key > 10 && item.name.toLowerCase().startsWith('l')));
